...
n_traj = 50
num_rep = 1
mutant_type_list = ['P16152']

co_dir = '/storage/home/yuj179/mygroup/protein_Ubq/continuous_synthesis/P16152/1-50/analysis/'
co_msm_data_file = co_dir+'msm_data.npz'
po_dir = '/storage/home/yuj179/mygroup/protein_Ubq/post_translation/P16152/1-50/analysis/'
...
def draw_pathways(ax, G, pos):
    ...
    label_pos = {}
    for p in pos.keys():
        label_pos[p] = list(np.array(pos[p])+np.array([0.05, 0.04]))
