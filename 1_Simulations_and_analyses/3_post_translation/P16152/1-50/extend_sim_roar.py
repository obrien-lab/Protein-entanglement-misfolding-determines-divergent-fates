...
psffile = 'prot_l277.psf'
ncrstfile = 'prot_l277_dissociation_final.ncrst'
fffile = '/storage/home/yuj179/mygroup/protein_Ubq/post_translation/P16152/1-50/setup/P16152_clean_nscal1_fnn1_go_bt.xml'
corfile = '/storage/home/yuj179/mygroup/protein_Ubq/post_translation/P16152/1-50/setup/P16152_clean_ca.cor'
sec_struct_def_file = '/storage/home/yuj179/mygroup/protein_Ubq/post_translation/P16152/1-50/setup/secondary_struc_defs.txt'
alpha = 1
timestep = 0.015
...
for ei in range(submit_start_id, submit_start_id+submit_num):
    ...
    if not tag_finish:
        ...
        f.write('''#!/bin/bash
#SBATCH -J P_P16152_'''+str(idx_traj)+'''_'''+str(idx_rep)+'''
